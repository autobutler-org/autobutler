...
/// One full-text search hit in the sheets list.
class SheetContentResultTile extends StatelessWidget {
  final ContentSearchResult result;

  const SheetContentResultTile({required this.result, super.key});

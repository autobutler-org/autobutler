...
VALUES (?, ?, ?)
RETURNING id, username, password_hash, recovery_phrase_hash, created_at, role
`
...
SELECT id, username, password_hash, recovery_phrase_hash, created_at, role FROM users ORDER BY id ASC LIMIT 1
`
...
SELECT id, username, password_hash, recovery_phrase_hash, created_at, role FROM users WHERE id = ? LIMIT 1
`
...
SELECT id, username, password_hash, recovery_phrase_hash, created_at, role FROM users WHERE username = ? LIMIT 1
`

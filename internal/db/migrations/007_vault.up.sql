...
-- Organizational folders for vault entries.
...
-- Credential entries. Sensitive fields are in the encrypted ciphertext blob.
-- name and url_host are plaintext for search/sort without requiring decryption.

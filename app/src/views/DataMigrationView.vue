<template>
  <LibraryLayout>
    ...
    <template #title>
      <h2 class="library-title">Data Migration</h2>
    </template>
    <template #subtitle>
      <div class="library-subtitle">
        Import your data from Google, iCloud, Dropbox, OneDrive, Box, and more
      </div>
    </template>
    <template #main>
...
.migration-card-icon {
  ...
  &.box {
    background: rgba(0, 111, 201, 0.15);
    color: #006fc9;
  }
}

.migration-card-description {

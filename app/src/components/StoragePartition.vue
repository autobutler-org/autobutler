...
function segmentClass(category: string) {
  switch (category) {
    case 'system':
      return 'storage-partition-system'
    case 'documents':
      return 'storage-partition-documents'
    case 'media':
      return 'storage-partition-media'
    case 'backups':
      return 'storage-partition-backups'
    case 'other':
      return 'storage-partition-other'
    default:
      return ''
  }
}
...
function segmentTitle(category: string, bytes: number) {
  ...
  switch (category) {
    case 'system':
      return `System: ${gb} GB`
    case 'documents':
      return `Documents: ${gb} GB`
    case 'media':
      return `Media: ${gb} GB`
    case 'backups':
      return `Backups: ${gb} GB`
    case 'other':
      return `Other: ${gb} GB`
    default:
      return `${category}: ${gb} GB`
  }
}

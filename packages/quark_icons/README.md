...
Custom icon font for Quark — spreadsheet and app-specific icons not covered by Material Icons.
...
3. Run `make generate/frontend/quark-icons` from the **repo root** (not this package)
...
```bash
make generate/frontend/quark-icons
```

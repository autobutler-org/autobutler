...
import (
	...
	"autobutler/pkg/ui/components/icons/trash"
	"fmt"
)
...
func ComponentWithEvent(
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if !isNew {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 22, Col: 50}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 27, Col: 68}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 63, Col: 35}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 69, Col: 57}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 75, Col: 34}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 103, Col: 25}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 119, Col: 45}
		}
		...
		if event.EndTime == nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 142, Col: 46}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 156, Col: 25}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 169, Col: 28}
		}
		...
		if isNew {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/ui/components/calendar/event_editor/component.templ`, Line: 222, Col: 21}
			}

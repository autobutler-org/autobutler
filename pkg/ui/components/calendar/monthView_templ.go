...
import "autobutler/pkg/util/deputil"

func monthView(now time.Time, deps deputil.Dependencies) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		events, err := deps.Database().QueryCalendarEventsForMonth(db.DefaultCalendarId, now.Year(), now.Month(), true)
		if err != nil {

...
type RunFonts struct {
	...
	AsciiTheme    ThemeFont `xml:"asciiTheme,attr,omitempty"`
	HAnsiTheme    ThemeFont `xml:"hAnsiTheme,attr,omitempty"`
	EastAsiaTheme ThemeFont `xml:"eastAsiaTheme,attr,omitempty"`
	CSTheme       ThemeFont `xml:"cstheme,attr,omitempty"`
}

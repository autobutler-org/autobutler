...
type Style struct {
	...
	RevID *GenSingleStrVal[Hex] `xml:"rsid,omitempty"`

	//17. Style Paragraph Properties
	ParaProp *ParagraphProperty `xml:"pPr,omitempty"`
	...
	//Style Type
	Type *StyleType `xml:"type,attr,omitempty"`

	//Style ID
	ID *string `xml:"styleId,attr,omitempty"`

	//Default Style
	Default *OnOffValue `xml:"default,attr,omitempty"`

	//User-Defined Style
	CustomStyle *OnOffValue `xml:"customStyle,attr,omitempty"`
}

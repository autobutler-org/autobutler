...
type RunProperty struct {
	...
	//27.Underline
	Underline *GenSingleStrVal[Underline] `xml:"http://schemas.openxmlformats.org/wordprocessingml/2006/main w:u,omitempty"`
...
func NewRunProperty() *RunProperty {
	return &RunProperty{
		Underline: &GenSingleStrVal[Underline]{Val: UnderlineNone},
	}
}

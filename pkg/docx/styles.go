...
import "autobutler/pkg/docx/types"
...
//   - styleType: An types.StyleType indicating the type of style (e.g., paragraph, character, table).
//
// Returns:
//   - *types.Style: A pointer to the style matching the provided ID and type, if found; otherwise, nil.
//
...
func (rd *RootDoc) GetStyleByID(styleID string, styleType types.StyleType) *types.Style {
	if rd.DocStyles == nil {
		return nil
	}

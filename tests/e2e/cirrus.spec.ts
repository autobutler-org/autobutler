...
test.describe('Cirrus Page - File Interactions', () => {
    ...
    test('file viewer modal closes with close button', async ({ page }) => {
        ...
        // Click the close button (specifically for file viewer)
        const closeButton = fileViewer.locator('.dialog-close');
...
test.describe('Modal Dialog Behavior', () => {
    ...
    test('clicking outside of rename dialog should close rename modal', async ({ page }) => {
        ...
        const renameDialog = page.locator('#rename-dialog');
        await expect(renameDialog).toBeVisible();

        // Get the dialog box
        const dialogBoundingBox = await renameDialog.boundingBox();
    ...
    test('close button should properly close rename dialog', async ({ page }) => {
        ...
        const closeButton = renameDialog.locator('.dialog-close');
        await closeButton.click();
...
test.describe('Column View Navigation', () => {
    ...
    test('single-clicking folder in column view navigates without page reload', async ({
        ...
        const folder = page.locator('.column-view-item[data-name="test-nav-folder/"]');

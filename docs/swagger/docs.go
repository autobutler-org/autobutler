        ...
        "/s/{token}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Share password (if protected)",
                        "name": "password",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "Password required or wrong password",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
                    ...
                    "410": {
                        "description": "Link has reached its maximum use count",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/v0_shares.shareLinkJSON"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0_shares.createShareRequest"
                        }
                    }
                ],
                "responses": {

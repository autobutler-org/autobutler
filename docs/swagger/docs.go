...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v0_share.publicShareMeta"
                        }
                    },
                    "404": {
        ...
        "/public/share/{token}/download": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Share not found, expired, or resource missing",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/v0_share.shareLinkSummary"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0_share.createShareRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/v0_share.createShareResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/share/{tokenHash}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Token hash returned by GET /share",
                        "name": "tokenHash",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "v0_share.createShareRequest": {
            ...
            "properties": {
                "deviceSerial": {
                    "description": "DeviceSerial identifies the storage device (empty for the default device).",
                    "type": "string"
                },
                "expiresInHours": {
                    "description": "ExpiresInHours is the TTL in hours. 0 or negative means no expiry.",
                    "type": "integer"
                },
                "resourcePath": {
                    "description": "ResourcePath is the file/folder path relative to the device's Cirrus root.",
                    "type": "string"
                },
                "resourceType": {
                    "description": "ResourceType is \"file\" or \"folder\".",
                    "type": "string"
                }
            }
        },
        "v0_share.createShareResponse": {
            "type": "object",
            "properties": {
                "expiresAt": {
                    "type": "string"

...
const docTemplate = `{
        ...
        "/cirrus/search/content": {
            "get": {
                ...
                "responses": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "results": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/v0_files.ContentResultJSON"
                                    }
                                }
                            }
                        }
                    ...
                    "503": {
                        "description": "FTS index not available",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    }
    ...
    "definitions": {
        ...
        "v0_files.ContentResultJSON": {
            "type": "object",
            "properties": {
                "path": {
                    "description": "Path is the relative file path within the Cirrus data directory.",
                    "type": "string"
                },
                "snippet": {
                    "description": "Snippet is a short context extract around the matching terms, with HTML\n\u003cmark\u003e tags wrapping matches. May be empty when the match is in metadata.",
                    "type": "string"
                }
            }
        },

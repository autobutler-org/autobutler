...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/pluginutil.Manifest"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/pluginutil.MarketplaceEntry"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "pluginutil.Contributes": {
            "type": "object",
            "properties": {
                "navItem": {
                    "$ref": "#/definitions/pluginutil.NavItem"
                },
                "page": {
                    "$ref": "#/definitions/pluginutil.PluginNode"
                },
                "settingsPanel": {
                    "type": "boolean"
                }
        ...
        "pluginutil.Manifest": {
            ...
            "properties": {
                ...
                "contributes": {
                    "$ref": "#/definitions/pluginutil.Contributes"
                },
                "description": {
                    "type": "string"
                },
        ...
        "pluginutil.PluginNode": {
            ...
            "properties": {
                ...
                "padding": {
                    "description": "padding: all-sides shorthand",
                    "type": "number"
                },
                "size": {
                    "description": "icon size / sized_box dimension",
                    "type": "number"
                },
                "style": {
                    "description": "text: headline|title|body|caption",
                    "type": "string"
                },
                "type": {
                    "type": "string"
                ...
                "url": {
                    "description": "button: launch URL",
                    "type": "string"
                },
                "value": {
                    "description": "text content / icon name",
                    "type": "string"
                }
            }
        },
